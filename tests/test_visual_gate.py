...
class RubricVersionBumped(unittest.TestCase):
    ...
    inclui o genus rite v6: old-edge grounded rite, reader growth, lineage ledger,
    mecanismo, grounding/fact-audit e canonical form grammar."""

    def test_version_label_is_6(self):
