...
TASKS_LOG_FILE="$STATE_DIR/tasks.jsonl"
...
<<<<<<< HEAD
  CURRENT_BEAT_FILE CURRENT_DISPATCH_FILE TASKS_SNAPSHOT_FILE TASKS_LOG_FILE CURADORIA_CANDIDATES_FILE PROPOSALS_FILE PROCEDURE_CURATION_FILE SOURCE_USAGE_FILE SOURCES_MANIFEST_FILE PRIMITIVES_STATUS_FILE RENDER_INSTALL_DRIFT_FILE OPS_HOTSPOTS \
