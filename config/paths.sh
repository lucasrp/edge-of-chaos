...
export \
  ...
  CURRENT_BEAT_FILE CURRENT_DISPATCH_FILE CURADORIA_CANDIDATES_FILE PROPOSALS_FILE PROCEDURE_CURATION_FILE SOURCE_USAGE_FILE SOURCES_MANIFEST_FILE OPS_HOTSPOTS \
