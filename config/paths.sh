...
export \
  ...
  CURRENT_BEAT_FILE CURRENT_DISPATCH_FILE TASKS_SNAPSHOT_FILE CURADORIA_CANDIDATES_FILE CURATION_DIGEST_FILE PROPOSALS_FILE PROCEDURE_CURATION_FILE WORKFLOW_HEALTH_FILE FIRST_STEPS_FILE DISPATCH_QUEUE_FILE HEARTBEAT_ROTATION_FILE SOURCE_USAGE_FILE SOURCES_MANIFEST_FILE SOURCE_AFFORDANCE_DIGEST_FILE PRIMITIVES_STATUS_FILE CAPABILITIES_STATUS_FILE RENDER_INSTALL_DRIFT_FILE DISPATCH_CYCLES_FILE PIPELINE_STATE_FILE OPERATOR_PRESSURE_PROJECTION_FILE CLAIMS_DIGEST_FILE ORPHAN_CLAIMS_FILE CLAIMS_VALIDATION_FILE CONTINUITY_DELTAS_DIR PREFLIGHT_LOG_FILE OPS_HOTSPOTS \
