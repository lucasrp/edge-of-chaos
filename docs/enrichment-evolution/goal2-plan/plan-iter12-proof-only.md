...
- **P2 (decidida por S3a):** store **durável content-addressed** — evento append-only no eventlog
  (valores+hash) OU store de run novo; **blob de Artefato publicado está FORA** (prunable, ADR-0006).
