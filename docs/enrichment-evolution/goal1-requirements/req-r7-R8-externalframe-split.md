...
- **R8 — Tier "internal-evidence" no gate de cite/grounding (bloqueante p/ Artefato de medição).** Dado
  ...
  **proveniência INTERNA** (run_id, ref ao artefato de origem) em vez de cite externo, **apenas no gate
  de cite/grounding e apenas para claims numéricos internos**. **CISÃO obrigatória (gate reframe-3,
