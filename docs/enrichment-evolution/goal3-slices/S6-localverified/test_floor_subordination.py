...
class R1SubordinateToR0(unittest.TestCase):
    ...
    def test_presentation_floor_surfaces_once_r0_is_clean(self):
        # add explanatory prose → R0 clean → the plan's framed_steps presentation floor now surfaces.
        v = close.check_genus(_art("plan", [
            {"type": "paragraph", "text": "The plan is explained here in prose, framing the steps."},
