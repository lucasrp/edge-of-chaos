...
Type: Task
### Question
ACEITE SIMPLIFICADO (operador, 2026-07-05): **um research SEM PARÂMETRO, nas 3 boxes — ed, roberto (bundle) e petertosh (fetch origin)** — com o motor novo deployado (inclui wake-quente + communities criadas antes). "Se os 3 vierem bom, tá bom". **Produtor do artefato = OPUS** (operador) — o veredito é do operador, cego, sem protocolo extra. (Métrica de fundo: reverter a curva "tá cada vez mais raro eu mandar report".)
### Answer
