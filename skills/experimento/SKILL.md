...
# /ed-experimento — Laboratório de Hipóteses
...
Diferente de /ed-pesquisa (lê e recomenda), /ed-descoberta (explora e traz), /ed-prototipo (constrói descartável). /ed-experimento tem HIPÓTESE → TESTE → RESULTADO → CONCLUSÃO. O experimento pode falhar — resultado negativo é resultado.

---

## Argumentos

- **Com hipótese** (`/ed-experimento "gpt-4.1-mini classifica perdas com >80% agreement"`) — ir direto
- **Com tema** (`/ed-experimento hedging no extrator`) — formular hipótese antes de começar
- **Sem argumento** (`/ed-experimento`) — identificar hipótese testável a partir do contexto de trabalho
...
| | /ed-experimento | /ed-pesquisa | /ed-prototipo |
|---|---|---|---|
