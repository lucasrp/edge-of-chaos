...
`/ed-prototipo` e diferente: o artefato e COMUNICACAO, nao entrega. Como Feynman desenhando diagramas no quadro — o diagrama nao e o reator, mas quem viu entendeu fissao nuclear.

---

## Quando usar

- Uma proposta do `/ed-planejar` ficaria mais clara com demo visual
- Uma descoberta do `/ed-pesquisa` ou `/ed-descoberta` e mais facil de mostrar que explicar
...
- **Com ideia** (`/ed-prototipo visualize o fluxo do pipeline`): construir isso
- **Com referencia** (`/ed-prototipo proposta #16`): construir demo que ilustre a proposta
- **Sem argumento** (`/ed-prototipo`): identificar a partir do contexto recente o que se beneficiaria de demo
...
**Referencia:** [proposta/pesquisa/ed-descoberta que motivou, se houver]
...
- **Referencia:** [proposta/ed-pesquisa que motivou]
```
...
| Skill | Relacao |
|-------|---------|
| /ed-pesquisa | Prototipo pode ilustrar uma descoberta. Pesquisa fundamenta, prototipo mostra |
| /ed-descoberta | Ferramenta descoberta pode virar demo rapido |
| /ed-planejar | Proposta pode ganhar demo para tornar concreto o que propoe |
| /ed-lazer | Builds de lazer sao primos — mas lazer e curiosidade livre, prototipo e comunicacao dirigida |
...
- Pode ser invocado dentro de outras skills (ex: durante /ed-pesquisa, "vou fazer um prototipo rapido pra mostrar")
