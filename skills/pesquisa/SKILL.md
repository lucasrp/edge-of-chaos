...
Sei O QUE quero aprender — preciso aprofundar. Pesquisa focada num tema, ferramenta, ou problema especifico. Diferente da /ed-descoberta (que explora livremente), a /ed-pesquisa parte de um alvo claro.

Exemplos: "/ed-pesquisa DSPy", "/ed-pesquisa como reduzir custo de tokens", "/ed-pesquisa padroes de pipeline".

---

## Argumentos Opcionais

- **Sem argumento** (`/ed-pesquisa`): identificar alvo automaticamente a partir de friction points do contexto
- **Com tema** (`/ed-pesquisa DSPy`): pesquisar esse tema em profundidade
- **Com problema** (`/ed-pesquisa como otimizar o fluxo do pipeline`): pesquisar solucao para esse problema
- **Modo Feynman** (`/ed-pesquisa feynman backpropagation` ou `/feynman X`): entendimento profundo — derivar antes de pesquisar, ensinar para testar entendimento, rastrear gaps
...
| | /ed-pesquisa (padrao) | /ed-pesquisa feynman | /ed-descoberta |
|---|---|---|---|
...
- Diferenciar: o que fazer agora vs o que investigar depois vs ideias para /ed-planejar
...
- Pesquisa e DIRIGIDA — parte de um alvo conhecido. Para exploracao livre, usar /ed-descoberta
