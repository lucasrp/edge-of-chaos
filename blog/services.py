...
from paths import (
    EDGE_DIR, STATE_DIR, THREADS_DIR, LOGS_DIR,
    ENTRIES_DIR, OPS_HOTSPOTS, LEDGER_FILE, BRIEFING_FILE,
)
...
# BRIEFING_FILE already imported from paths
